...
function setupSpreadsheet_() {
  try {
    ...
    _ensureSheetWithHeaders_(SHEETS.COMMERCIAL_REGISTRATION, [
      COLUMNS.COMMERCIAL_REGISTRATION.OPPORTUNITY_ID, COLUMNS.COMMERCIAL_REGISTRATION.COMPANY_NAME_AR,
      COLUMNS.COMMERCIAL_REGISTRATION.CR_NUMBER, COLUMNS.COMMERCIAL_REGISTRATION.REPRESENTATIVE_NAME,
      COLUMNS.COMMERCIAL_REGISTRATION.ADDRESS,
      COLUMNS.COMMERCIAL_REGISTRATION.NATIONAL_NUMBER, COLUMNS.COMMERCIAL_REGISTRATION.CONFIDENCE,
      COLUMNS.COMMERCIAL_REGISTRATION.SOURCE_FILE_URL, COLUMNS.COMMERCIAL_REGISTRATION.IMPORTED_BY,
      COLUMNS.COMMERCIAL_REGISTRATION.IMPORTED_AT
    ]);
...
function _seedDefaultSettings_() {
  ...
  defaults[SETTINGS_KEYS.CR_ARCHIVE_FOLDER_ID] = '';
  defaults[SETTINGS_KEYS.OCR_PROVIDER] = 'drive';
  defaults[SETTINGS_KEYS.OCR_LANGUAGE] = 'ar';
  defaults[SETTINGS_KEYS.DEFAULT_CONTRACT_YEARS] = '1';
