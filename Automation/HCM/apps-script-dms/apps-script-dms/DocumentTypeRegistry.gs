...
var DOCUMENT_TYPES = {
  ...
  HCM_AGREEMENT: {
    ...
    fields: [
      ...
      { key: COLUMNS.HCM_AGREEMENT_DATA.COMMERCIAL_REGISTRATION, label: 'Client Commercial Registration No.', type: FIELD_TYPE.TEXT, required: true },
      { key: COLUMNS.HCM_AGREEMENT_DATA.REPRESENTATIVE_NAME, label: 'Client Representative Name', type: FIELD_TYPE.TEXT, required: true },
      { key: COLUMNS.HCM_AGREEMENT_DATA.COMPANY_ADDRESS, label: 'Client Company Address', type: FIELD_TYPE.TEXTAREA, required: true },
      { key: COLUMNS.HCM_AGREEMENT_DATA.AGREEMENT_DATE, label: 'Agreement Date', type: FIELD_TYPE.DATE, required: true },
      ...
      { key: COLUMNS.HCM_AGREEMENT_DATA.CONTRACT_DURATION_TEXT, label: 'Contract Duration (Arabic text, e.g. سنة ميلادية واحدة)', type: FIELD_TYPE.TEXT, required: true,
    ...
    buildPlaceholderMap: function (opportunity, fields, enabledServices) {
      return {
        CLIENT_NAME: opportunity[COLUMNS.OPPORTUNITIES.COMPANY],
        MONTH_YEAR: formatMonthYear_(new Date()),
        AGREEMENT_DATE: normalizeDateValue_(fields[COLUMNS.HCM_AGREEMENT_DATA.AGREEMENT_DATE]),
        ...
        COMMERCIAL_REGISTRATION: fields[COLUMNS.HCM_AGREEMENT_DATA.COMMERCIAL_REGISTRATION],
        REPRESENTATIVE_NAME: fields[COLUMNS.HCM_AGREEMENT_DATA.REPRESENTATIVE_NAME],
        COMPANY_ADDRESS: fields[COLUMNS.HCM_AGREEMENT_DATA.COMPANY_ADDRESS],
  ...
  OFFSHORING_AGREEMENT: {
    ...
    fields: [
      ...
      { key: COLUMNS.OFFSHORING_AGREEMENT_DATA.CURRENCY, label: 'Currency (Arabic word, e.g. دولار)', type: FIELD_TYPE.TEXT, required: true,
        defaultSettingKey: SETTINGS_KEYS.DEFAULT_CURRENCY_AR },
      { key: COLUMNS.OFFSHORING_AGREEMENT_DATA.COMMERCIAL_REGISTRATION, label: 'Client Commercial Registration No.', type: FIELD_TYPE.TEXT, required: true },
      { key: COLUMNS.OFFSHORING_AGREEMENT_DATA.REPRESENTATIVE_NAME, label: 'Client Representative Name', type: FIELD_TYPE.TEXT, required: true },
      { key: COLUMNS.OFFSHORING_AGREEMENT_DATA.COMPANY_ADDRESS, label: 'Client Company Address', type: FIELD_TYPE.TEXTAREA, required: true },
      { key: COLUMNS.OFFSHORING_AGREEMENT_DATA.AGREEMENT_DATE, label: 'Agreement Date', type: FIELD_TYPE.DATE, required: true },
      { key: COLUMNS.OFFSHORING_AGREEMENT_DATA.START_DATE, label: 'Contract Start Date (Arabic text, e.g. 1 أبريل 2026م)', type: FIELD_TYPE.TEXT, required: true },
      { key: COLUMNS.OFFSHORING_AGREEMENT_DATA.END_DATE, label: 'Contract End Date (Arabic text, e.g. 31 مارس 2027م)', type: FIELD_TYPE.TEXT, required: true }
    ],
    buildPlaceholderMap: function (opportunity, fields) {
      return {
        CLIENT_NAME: opportunity[COLUMNS.OPPORTUNITIES.COMPANY],
        AGREEMENT_DATE: normalizeDateValue_(fields[COLUMNS.OFFSHORING_AGREEMENT_DATA.AGREEMENT_DATE]),
        START_DATE: fields[COLUMNS.OFFSHORING_AGREEMENT_DATA.START_DATE],
        END_DATE: fields[COLUMNS.OFFSHORING_AGREEMENT_DATA.END_DATE],
        ...
        COMMERCIAL_REGISTRATION: fields[COLUMNS.OFFSHORING_AGREEMENT_DATA.COMMERCIAL_REGISTRATION],
        REPRESENTATIVE_NAME: fields[COLUMNS.OFFSHORING_AGREEMENT_DATA.REPRESENTATIVE_NAME],
        COMPANY_ADDRESS: fields[COLUMNS.OFFSHORING_AGREEMENT_DATA.COMPANY_ADDRESS]
      };
    }
  }
};
